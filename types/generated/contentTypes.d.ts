...
export interface ApiEditionEdition extends Schema.CollectionType {
  ...
  info: {
    description: 'Bedtime story editions/volumes';
    displayName: 'Edition';
    pluralName: 'editions';
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    volumeNumber: Attribute.Integer &
      Attribute.Required &
      Attribute.Unique &
      Attribute.SetMinMax<
        {
...
export interface ApiStoryStory extends Schema.CollectionType {
  ...
  info: {
    description: 'Individual bedtime stories';
    displayName: 'Story';
    pluralName: 'stories';
    singularName: 'story';
  };
  ...
  attributes: {
    backingTrack: Attribute.Media<'audios'> & Attribute.Required;
    combinedTrack: Attribute.Media<'audios'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::story.story',
      'oneToOne',
    ...
    narration: Attribute.Media<'audios'> & Attribute.Required;
    publishedAt: Attribute.DateTime;
...
export interface ApiUserSubscriptionUserSubscription
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    currentVolumeNumber: Attribute.Integer &
      Attribute.Required &
      Attribute.DefaultTo<1>;
    endDate: Attribute.Date & Attribute.Required;
    nextVolumeDate: Attribute.Date;
    planType: Attribute.Enumeration<['three_month', 'six_month', 'annual']> &
      Attribute.Required;
